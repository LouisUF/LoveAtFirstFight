...
public class textBoxDances : MonoBehaviour
{
    /*
     * Hello Team :)
     * 
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.collider.tag == "Player")
        {
            ...
            //Make dragon dance, then turn off current sprite, play animation, and turn on new sprite. Increment phase.
            //Add extra code here
            ...
            otherOption = GameObject.Find("Prances(Clone)");
            Destroy(otherOption);
